...
class TestPandasStock:
    def getData(self):
        ...
        df.to_csv("./python/量化交易/data/demo000001.csv", header=True, index=False)
        df.to_excel("./python/量化交易/data/demo000001.xlsx",header=True,index=False)
          
    
    def testReadFile(self):
        file_name = "./python/量化交易/data/demo000001.csv"
