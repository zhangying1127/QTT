...
class MyPython:
    ...
    def getData(self):
        ...
        df.to_csv("./python/量化交易/data/demo.csv", header=False, index=False)
        df.to_excel("./python/量化交易/data/demo.xlsx",header=True,index=False)
        #df.to_csv("./量化交易/data/demo.csv")

    def testReadFile(self):
        #file_name = "C:\\zy_pw\\量化交易\data\\demo.csv"
        file_name = "./python/量化交易/data/demo.csv"
...
# 月波动炫等于对数收益率的标准差除以其均值，再乘以交易日的平方根，通常交易月取12月
